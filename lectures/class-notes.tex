...
Show \url{python.org} website.  Load up IDLE, Python 3.6.
...
\begin{reflect}{Brent, S'17}
  ...
  \item Path 2: Alternatively, start by introducing functions, introduce basic
    while loops, then do the ``Guess my number'' lab.  Then introduce
    strings, and do the full doublets lab (with functions).
  \end{enumerate}
...
\begin{reflection}{Brent, S'16, S'17}
