...
temperatures.  Then write another function which does that twice.
Then trace execution.  Introduce an error and see the ``traceback''.
Draw a stack diagram with local variables.
