...
\begin{verbatim}
	...
	t = s.split(“n”)
	t is [“ba”, “a”, “a”]
can join together a list into a string
	t = [‘fun’, ‘sun’, ‘sub’, ‘rub’]
	delimiter = “ -> “
\end{verbatim}
\end{itemize}
...
\subsection*{Lists and aliasing}

Need to flesh this out!
\begin{verbatim}
equality.  Not the same as strings.  Can have same elements, but be different objects in space.
How do they work in functions?
	If you change a list inside a function, it changes the value outside the function too. 
	You’re accessing the same spot in memory.
