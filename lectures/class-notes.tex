...
Follow instructions at the end of the lab.  Email me with questions,
I'll try to check email regularly, work with a partner, good luck,
Wrap up Lab 3. Demonstrate the python Style Checker.  Do this 15
minutes, write up code for orbit_newton.py remind to write up
lab3_evaluation.txt as a TXT file.
