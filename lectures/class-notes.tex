...
\begin{itemize}
\item Bring origami paper, if needed (S '16 --- lab Tuesday)
\item [In lab: put website up on projector so everyone knows they are
  in the right place.]
\item [Meet students before class.]
\item Have students meet each other. (Meet $n$ (1,3) others. Name, where from,
  why taking this class, one of your favorite things.)
\item (S '16, lab time: make graph on board of who knows who.  Then use graph to
  have students introduce each other.  Start with meeting only 1 or 2.)
\end{itemize}
...
\emph{Note: in Spring 2016, lab was on Tuesday, hence the first
  meeting was a lab meeting.  Instead of doing Scratch intro, did origami.}
