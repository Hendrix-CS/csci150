...
\verb|print|.  The interpreter is great, but we donâ€™t want the user
...
\begin{verbatim}
name = input("€œWhat is your name?â€")
\end{verbatim}
...
\begin{reflect}{Gabe, F'16}
\begin{itemize}
\item Seems a bit short - took most students 2 hours.
...
Most modern computers use $64$ bits to represent an integer (\emph{how
  big is that?}); some use $32$. Show Python doesn't care, abstracted it away:
\begin{itemize}
