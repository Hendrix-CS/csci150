...
\end{reflect}
\begin{reflect}{Brent, S'18}
  I simply don't see any good way to fit the project in before the
  exam.  But I'm more OK with that this year because of the decision
  to push the exam back a day and do This Day in History lab before
  the exam.  The project can then just be a fun way for them to apply
  the skills they have learned (or to re-learn/solidify skills if they
  didn't quite get there on the exam).
\end{reflect}
...
\begin{reflect}{Brent, S'18}
  ...
  Then I plan to do an exercise re: tracing program execution.
\end{reflect}
...
XXX include S'17 frequency count code here.
