...
I then walk through the methods of a queue (add, remove, size, is_empty)
and some important words (front, back) and write up the super class Queue
with all the method bodies being “pass”.
...
the person in front of them. So we start with the is_empty case, and set
