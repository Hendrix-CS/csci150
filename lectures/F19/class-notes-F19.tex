...
\item \ready Quiz: function tracing
...
\begin{itemize}
\item \ready \textbf{Quiz} (strings): see \texttt{csci150-instructors/quiz/string.py}
...
Try to come up with as many different ways as you can.  Try to also
come up with some ways that seem like they might work but don't!
