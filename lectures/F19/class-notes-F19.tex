% -*- compile-command: "latexmk -pdf class-notes-F19.tex" -*-
...
\title{CSCI 150: Foundations of Computer Science \\ Fall 2019 Lecture
  Notes}

\maketitle

\firstclass{Introduction}
...
\begin{itemize}
\item Homework due Wednesday (Minecraft programming by hand).
...
\class{\ready Information encoding I}
...
\newpage
\class{\ready Information encoding II}
...
\item \ready AFTER exam (e.g. on Saturday), email them to tell them
...
\item \textbf{Assign Project 1}.  Linked from website. Due 1 week from today.
...
\newpage
\section{\notready Functions I: defining and calling functions (W 2/13)}
...
\newpage
\section*{\notready LAB: Guess My Number (2/13--14)}
...
\newpage
\section{\notready Functions III: Abstraction (M 2/18)}
...
\newpage
\section{\notready Lists III (F 3/1)}

\subsection*{Setup}

\begin{itemize}
\item \notready Practice exam is posted on the class website.  Not required and
  not collected, but good practice---we will go over it on Monday.
  Exam is Wednesday.
\item \notready \textbf{Quiz} (\texttt{csci150-instructors/quiz/string.py})
\end{itemize}
...
\newpage
\section{\notready Recursion I: intro (F 3/8)}

\subsection*{Setup}
\begin{itemize}
\item \notready Need to write a HW!
...
\newpage
\section{\notready Recursion II: recursive functions (M 3/11)}
...
\newpage
\section{\notready More for loops: index ranges (W 3/27)}
...
\section*{\notready LAB: Caesar's Secrets (3/27--28)}
...
\section{\notready Mutability, objects, and references (F 3/29)}
