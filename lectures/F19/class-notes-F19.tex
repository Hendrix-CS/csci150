...
Point out that this version of \texttt{int_input} works, but it has a
...
The code for this version of \texttt{int_input} is a little longer,
...
allow it.  Challenge them to modify \texttt{int_input} to allow this
