...
Point out that this version of \verb|int_input| works, but it has a
...
The code for this version of \verb|int_input| is a little longer,
...
allow it.  Challenge them to modify \verb|int_input| to allow this
