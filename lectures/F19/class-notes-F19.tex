% -*- compile-command: "pdflatex class-notes-F19.tex" -*-
...
\newpage
\section{\notready Tracing I (F 1/25)}

\subsection*{Setup}
\begin{itemize}
\item \notready \textbf{Quiz (Python syntax and arithmetic)}.  See
...
\item TA hours!!  Use as group study session.
\end{itemize}
...
\section{\notready Information encoding I (F 2/1)}
...
\item \notready HW due Monday (conditional practice).
...
\newpage
\section{\notready Information encoding II (M 2/4)}

\subsection*{Setup}
\begin{itemize}
\item \notready \textbf{Quiz}: booleans and conditionals
...
\item \notready \textbf{Assign project 1}---due Monday Feb 18.  You might
...
\newpage
\section*{\notready LAB: This Day in History (2/6--7)}
...
\begin{reflect}{Brent, F'19}
  Somewhere around this point in the course we have to introduce basic
  I/O, \texttt{.py} files, comments.  Not sure if it should go here
  but dumping it here for now.
\end{reflect}
