...
\textbf{Tell students about style checker partway through the lab.}

XXX HOW TO USE style checker with Azure notebooks??
...
\begin{reflect}{Brent, F'19}
  Should we introduce very basic strings, just to give us something to
  do examples with?  \emph{i.e.} maybe just introduce them as
  characters inside quotes, don't mention different kinds of quotes,
  escape sequences, or anything like that yet?

  XXX Need to introduce basic strings somewhere here --- they are
  needed for Heart Disease lab.
\end{reflect}
...
\begin{reflect}{Brent, S'19}
  Only made it to here.  But had an extra class to cover the material
  on conditionals.
\end{reflect}
