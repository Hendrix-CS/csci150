...
Do more class/object examples:
\begin{itemize}
\item Fountain (see example from past exams)
\item Car (gas, gas tank capacity, mileage, mpg; fill, drive)
\end{itemize}
...
More examples: book + shelf?  Elevator simulation?
