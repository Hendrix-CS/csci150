% -*- compile-command: "latexmk -pdf class-notes-S25.tex" -*-
...
\title{CSCI 150: Foundations of Computer Science \\ Fall 2023 Lecture
  Notes}
...
\begin{itemize}
\item \ready Homework due Monday (Minecraft programming by hand).
...
\item Syllabus.  Grading might seem a bit strange at first, but
  ...
  \begin{itemize}
  \item Homework.  Credit/no credit.
  \item Quizzes.  Every Wednesday.  2/1/0.
  \item Labs.  First lab today/tomorrow!  Talk about location.
  \item Projects. Points for L1, L2, on time.
  \end{itemize}
\item Final grades: Lab points, HW/Quiz points, Project points.
  Complete a certain number to get a given grade.
...
Get help if you need it.  Write a little bit of code every day.  Redo
code from class and lab.  Key: \textbf{active} engagement!  This class
is about teaching you a new way of thinking/problem solving, not about
teaching you a set of facts.
...
\begin{reflect}{Brent, S'25}
  Skipped the pair simulation exercise this time.
\end{reflect}
...
\begin{itemize}
\item \ready Start with CS history (Antikythera mechanism).
  ...
  3rd floor!
\item \ready Reminder of HW. Quiz Wednesday on variables + math.
\end{itemize}
...
\subsection*{Setup}
\begin{itemize}
\item Collect math practice HW.
\item Hand back graded Minecraft HW.
\item Mention HW assigned today (Boolean practice).
\item Mention quiz Wednesday: will show Minecraft scenario, give a
  goal, you must write some code.
\end{itemize}
...
\begin{itemize}
\item Remember to leave 10--15 minutes at the end of class for the quiz.
\end{itemize}
...
Introduce PyCharm.  Help them get it installed on their personal
laptops.
...
\begin{itemize}
\item CS history!
\item Point out homework assignment: CodingBat
\end{itemize}
...
\item \verb|print| command: prints out stuff on the console.
  ...
  Explain difference between \verb|print| and \verb|return|.
  \begin{itemize}
...
\newpage
\class{\ready More Conditional Practice}

\subsection*{Setup}

\begin{itemize}
\item Mention TA evening lab hours!
\item Remember to leave 20 minutes for quiz @ end!
\end{itemize}

Do some CodingBat exercises together---Python Logic-2. (The Logic-1
are all for homework.)  Get them to find a partner or 2, work on them
together on paper?

\begin{reflect}{Brent, S'25}
  Had them find a random partner and work out \verb|lone_sum|
  together, then typed up a solution and talked through it.  On
  particular thing we talked about was the need to put the most
  specific cases first.  This came up multiple times in the lab which
  worked out well: students we able to make the connection.

  Then had them go back to their seats, called up a volunteer, and had
  them all tell the volunteer what to type in order to solve
  \verb|no_teen_sum|.  Worked fairly well.  I told them once they said
  something they should wait for 3 or 4 other people to talk before
  saying something again; they didn't all stick to that exactly but I
  think it was better than it could have been, maybe 5 or 6 people
...
\subsection*{Setup}
\begin{itemize}
\item \textbf{Assign Project 1}.  Linked from website. Due 2 weeks from
  today.
\item Mention CodingBat HW.
\item History: Babbage + Lovelace
\end{itemize}
...
\begin{itemize}
\item \ready HW due in 2 weeks (function stack tracing); see also
  CodingBat HW.
\item Project 1 due Friday.
\end{itemize}
...
\newpage
\class{\ready More while loop practice}

\subsection*{Setup/administrivia}

\begin{itemize}
\item Remember to leave time for quiz!
\item Hand back graded stuff, remind about revising
\item Reminders: project 1 due Friday at midnight.
\end{itemize}
...
If time, start on binary encoding.
...
\subsection*{Setup}
\begin{itemize}
\item Remind them of LhtL sessions?
\item Quiz Wednesday: conditionals
\end{itemize}
...
Show them \verb|read_inputs| function.

\subsection*{Repetition}

Show them \verb|*| operator on lists (and strings?).
...
\begin{itemize}
\item Note new CodingBat HW, due after spring break.
\item Note project 2 due at end of week after spring break.  We'll
  talk about file I/O on Friday.
\end{itemize}
...
\begin{itemize}
\item Lab this week, due after spring break.
\end{itemize}
...
which returns a string that includes all the newline characters, or
...
\newpage
\class{\ready Dictionaries}

\begin{itemize}
\item Project 2 due Friday!
\item Quiz (lists + loops) Wednesday!
\item New HW!
\end{itemize}
...
\item Project 2 due Friday!
\item Bioinformatics!
\item REMEMBER TO MAKE TIME FOR QUIZ
\end{itemize}
...
\begin{itemize}
\item New HW assignment, due in one week.
\item Note no quiz this Wednesday.
\end{itemize}
...
More class/object examples: fountain, car.  Here's the code we ended
up with in spring 2025:
...
\begin{itemize}
\item Reminder: final project design document due 1 week from today.
  Come talk to me if you want help brainstorming!
\item Look at classes HW.  Due Monday.  Can turn in electronically via
  submission form.
\end{itemize}
...
\item Note no exam 3.
% \item Quiz on classes/objects reading/tracing?
\end{itemize}
