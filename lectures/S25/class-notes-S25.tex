...
\subsection*{Setup}
\begin{itemize}
\item \notready Show them HW: CodingBat string \& loop practice
\end{itemize}
...
\subsection*{Setup}
\begin{itemize}
\item Note CodingBat HW.
\item Show them Python Tutor.  Paste in an example.
\end{itemize}
...
\item \notready Practice exam is posted on the class website.  Talk
  ...
  exam, then take it under test conditions!  Come in on Friday ready
...
\newpage
\class{\notready Dictionary practice}

FINISH writing \verb|frequency_count| and \verb|normalize| from last
class.  Trace it, showing heap. Maybe run them on the contents of a file.

% \newpage
% \class{\notready Project 2 demo}

% Introduce \notready Project 2 (word games).
...
\item Exam 1 Monday, do practice exam for Friday!
  \begin{itemize}
    \item In-class vs take-home
    \item No PyCharm, I/O stuff on lab this week or HW
  \end{itemize}
\item HW due today, will also collect older HW
\item Remember: can always ask for any extensions
\item Show how to sign up for office hours
\end{itemize}
