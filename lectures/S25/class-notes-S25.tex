...
\begin{reflect}{Brent, S'25}
  ...
  together, then typed up a solution and talked through it.
...
\subsection*{Setup}
\begin{itemize}
\item \textbf{Assign Project 1}.  Linked from website. Due 1.5 weeks from
  today (midnight on Monday).
\item History: ENIAC. Show Wikipedia page, watch ENIAC programmers
  trailer.
\end{itemize}
