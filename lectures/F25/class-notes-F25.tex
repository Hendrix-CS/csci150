...
\class{\notready Introduction to the course}

\subsection*{Setup/administrivia}
\begin{itemize}
\item \notready Homework due Monday (Minecraft programming by hand).
...
\begin{itemize}
\item \notready Start with CS history (Antikythera mechanism).
  ...
  3rd floor!
\item \notready Reminder of HW. Quiz Wednesday on variables + math.
\end{itemize}
...
\newpage
\lab{\notready Big Data/Heart Disease}
...
\newpage
\class{\notready More Conditional Practice}
...
\begin{itemize}
\item \notready HW due in 2 weeks (function stack tracing); see also
  CodingBat HW.
...
\newpage
\class{\notready More while loop practice}
...
\lab{\notready Asteriskbucks}

\class{\notready Final project discussion}
