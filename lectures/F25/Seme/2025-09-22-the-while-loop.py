...
def enter_numb():
    continue  # this line is here as a 'blank' space; python does not like a function
                # or if statement without code underneath
...
# Also notice all of the underlining going on
