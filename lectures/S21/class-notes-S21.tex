...
\begin{reflect}{Brent, S'21}
  Due to COVID and social distancing, couldn't really have groups
  swap.  Just going to try having pairs work together ??? to make an
  exercise and then pick a group that has a tricky one to work through
  together?
\end{reflect}
