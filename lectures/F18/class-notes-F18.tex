...
\begin{itemize}
\item Practice exam is posted on the class website.
\end{itemize}

XXX write me.  Do more practice exercises, like what's going to be on
the exam, or do something a bit bigger.
...
\begin{reflect}{Brent, F'18}
  Again on the Wednesday right before fall break.
\end{reflect}
...
\newpage
\section{For loop practice (W 10/17)}
...
\section{Mutability, objects, references, tracing with stack \& heap (F 10/19)}
...
Ask: what gets printed?

XXX show them formally how to do tracing with stack \& heap in order
to understand this.
