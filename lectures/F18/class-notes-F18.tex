...
Today's focus is on getting them to do more hands-on exercises writing
code using strings, loops, and functions.

XXX add more practice exercises.

Do version of \verb|int_input| that accepts negative numbers as well
as positive (uses indexing, slicing, \verb|or|). For example:
