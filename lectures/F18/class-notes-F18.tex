...
\begin{reflect}{Brent, F'18}
  ...
  \item The usual things re conditions \emph{e.g.} writing \verb|if month
    == 3 or 5|, or \verb|if month = 3|, or writing a sequence of
    \verb|if| instead of \verb|if... elif... elif|.
  \end{itemize}
