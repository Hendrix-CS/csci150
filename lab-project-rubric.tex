% -*- compile-command: "pdflatex lab-project-rubric.tex" -*-
...
\begin{landscape}
  {\Large CSCI 150, Foundations of Computer Science: Lab and Project
    Rubric} \hfill v2, July 2019 \bigskip
  ...
  \begin{longtable}{p{1in}p{2.2in}p{2.2in}p{2.2in}p{2.2in}}
    ...
    comments explaining any interesting or nonobvious code.  Functions
    are correctly annotated with their input and output types.  If there
    ...
    vague, or confusing.  Some functions may be missing type
    annotations.  A README file may be lacking some detail.
    & Many parts of the program are uncommented, or comments are
    unhelpful.
    \\
    \midrule
    \textbf{Style}
